<?php
$accordion_parent =
    qrcdr()->getConfig('accordion') == true
...
<div class="accordion" id="collapseSettings">
    ...
    <div class="collapse<?php echo $collapsed; ?>" id="collapseStyle"<?php echo $accordion_parent; ?>>
        ...
        foreach ($markers as $marker => $values) {
            ...
            $markerselecta .=
                '<label class="btn btn-light p-1">
                <input type="radio" name="marker" value="' .
                $marker .
                '" ' .
                $activeattr .
                '>
        ...
        foreach ($markersIn as $marker => $values) {
            if (isset($values['marker'])) {
                ...
                $markerselectaIn .=
                    '<label class="btn btn-light p-1">
                    <input type="radio" name="marker_in" value="' .
                    $marker .
                    '" ' .
                    $activeattr .
                    '>
        ...
        foreach ($frames as $frame => $values) {
            ...
            $viewH =
                isset($values['label_size']) && isset($values['label_offset'])
                    ? 24 + $values['label_size'] + 2 + $values['label_offset']
                    : 24;
            $frameselecta .=
                '<label class="btn btn-light p-1">
                <input type="radio" name="outer_frame" value="' .
                $frame .
                '" ' .
                $activeattr .
                '>
                <svg width="48" height="56" viewBox="0 0 24 ' .
                $viewH .
                ...
                <div class="row">
                    <div class="col-12 mt-2">
                        <div class="custom-control custom-switch">
                          ...
                          <label class="custom-control-label" for="different-markers-bg"><?php echo qrcdr()->getString(
        ...
        <div class="col-12 mb-2">
            ...
            <div class="form-group mt-2">
                <div class="custom-control custom-switch">
                  ...
                  <label class="custom-control-label" for="frame-color"><?php echo qrcdr()->getString(
                      'custom_frame_color'
                  ); ?></label>
                </div>
            </div>
